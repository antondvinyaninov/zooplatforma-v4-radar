...
//#region node_modules/@vkontakte/vk-bridge/dist/index.umd.js
var require_index_umd = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(e, n) {
		...
		function a(e, t, r) {
			...
			return t((function(e) {
				if (e.detail && e.detail.data && "object" == typeof e.detail.data && "request_id" in e.detail.data) {
					var n = e.detail.data, t = n.request_id, r = function(e, n) {
						var t = {};
				...
				return void 0 === r && (r = {}), new Promise((function(a, i) {
					...
					e(t, n(n({}, r), { request_id: p }));
				}));
			};
		}
		var i, p = "undefined" != typeof window, s = Boolean(p && window.AndroidBridge), u = Boolean(p && window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.VKWebAppClose), c = Boolean(p && window.ReactNativeWebView && "function" == typeof window.ReactNativeWebView.postMessage), d = p && !s && !u, l = d && /(^\?|&)vk_platform=mobile_web(&|$)/.test(location.search), f = d ? "message" : "VKWebAppEvent", b = o([
			"VKWebAppInit",
		...
		] : ["VKWebAppShowImages"], !0), A = p ? window.AndroidBridge : void 0, v = u ? window.webkit.messageHandlers : void 0, h = d ? parent : void 0;
		...
		var O = function(e) {
			var n = void 0, p = [], l = Math.random().toString(36).substring(2, 5);
			function m(e) {
				p.push(e);
			}
			function w(e) {
			...
			function K(e) {
				...
				if (d && t) {
					...
					var r = t.type, a = t.data, i = t.frameId;
						...
						return r(this, (function(t) {
							switch (t.label) {
								...
								case 1: return t.trys.push([
									...
									,
									4
								]), [4, _("SetSupportedHandlers")];
								case 2: return n = t.sent(), i = new Set(n.supportedHandlers), [3, 4];
								case 3: return t.sent(), i = new Set(["VKWebAppInit"]), [3, 4];
								case 4: return [2, i.has(e)];
							}
						}));
					}));
				},
		...
		e.applyMiddleware = function e() {
			...
			var t = {};
			try {
				new URLSearchParams(n).forEach((function(n, r) {
					switch (r) {
						case "vk_ts":
						...
						case "vk_viewer_group_role":
							...
							break;
						case "vk_platform": t.vk_platform = function(n) {
