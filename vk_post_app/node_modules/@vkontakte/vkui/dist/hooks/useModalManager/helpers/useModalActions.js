...
const createModalCallbacks = (id, modalProps, store, resolvePromise)=>{
    const onClose = (reason, event)=>{
        var _modalProps_onClose;
        store.setPrevActive(id);
        (_modalProps_onClose = modalProps.onClose) === null || _modalProps_onClose === void 0 ? void 0 : _modalProps_onClose.call(modalProps, reason, event);
    };
    const onClosed = ()=>{
        var _modalProps_onClosed;
        if (store.needCloseModals.has(id)) {
            store.removeModal(id);
            store.needCloseModals.delete(id);
            resolvePromise();
        }
        (_modalProps_onClosed = modalProps.onClosed) === null || _modalProps_onClosed === void 0 ? void 0 : _modalProps_onClosed.call(modalProps);
    };
    return {
        onClose,
        onClosed
