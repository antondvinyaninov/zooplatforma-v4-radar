...
const collectFocusable = (root)=>{
    ...
    const nodes = Array.from(newFocusableElements).filter((node)=>{
        ...
        const isDisabled = (_node_disabled = node.disabled) !== null && _node_disabled !== void 0 ? _node_disabled : false;
...
export const useFocusTrap = (ref, { mount = true, disabled = false, autoFocus = true, restoreFocus = true, autoFocusDelay = 0, mutationObserverOptions })=>{
    ...
    const onMutateParentHandler = useStableCallback((parentNode)=>{
        ...
        const doc = (_getWindow = getWindow(parentNode)) === null || _getWindow === void 0 ? void 0 : _getWindow.document;
        if (!doc) {
            return;
        }
