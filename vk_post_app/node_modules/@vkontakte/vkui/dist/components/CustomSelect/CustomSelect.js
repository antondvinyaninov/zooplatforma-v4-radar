 ...
 */ export function CustomSelect(props) {
    ...
    const { onClick: onRootClick, onMouseMove: onRootMouseMove, onMouseDown: onRootMouseDown, getRootRef: rootRef, ...rootRest } = useMergeProps(restProps, slotProps === null || slotProps === void 0 ? void 0 : slotProps.root);
    ...
    const propsValue = React.useMemo(()=>{
        ...
        return (_ref = (_getOptionByValue = getOptionByValue(options, selectValue)) === null || _getOptionByValue === void 0 ? void 0 : _getOptionByValue.value) !== null && _ref !== void 0 ? _ref : null;
    }, [
        options,
        selectValue
    ]);
    ...
    const onClick = (event)=>{
        onRootClick === null || onRootClick === void 0 ? void 0 : onRootClick(event);
        passClickAndFocusToInputOnClick(event);
    };
    const onMouseDown = (event)=>{
        onRootMouseDown === null || onRootMouseDown === void 0 ? void 0 : onRootMouseDown(event);
        preventInputBlurWhenClickInsideFocusedSelectArea(event);
    };
    const onMouseMove = (event)=>{
        onRootMouseMove === null || onRootMouseMove === void 0 ? void 0 : onRootMouseMove(event);
        updateLastMousePosition(event);
    };
    const onCustomSelectInputFocus = (event)=>{
        onFocus();
        onInputFocus === null || onInputFocus === void 0 ? void 0 : onInputFocus(event);
    };
