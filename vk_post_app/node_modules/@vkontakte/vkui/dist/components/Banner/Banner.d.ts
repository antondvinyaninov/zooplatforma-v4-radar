 ...
 */
export declare const Banner: ({ mode, imageTheme: imageThemeProp, size, before, after: afterProp, title, subtitle, extraSubtitle, children, background, actions, onDismiss, dismissLabel, Component, ...restProps }: BannerProps) => React.ReactNode;
