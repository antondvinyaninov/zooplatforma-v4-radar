 ...
 */
export declare const CustomSelectOption: ({ children, hierarchy, hovered: hoveredProp, selected, before, after, description, disabled, textNoWrap, style: styleProp, className, onClick, ...restProps }: CustomSelectOptionProps) => React.ReactNode;
