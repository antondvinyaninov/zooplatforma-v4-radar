...
placeholder: placeholderProp = 'Поиск', autoComplete = 'off', autoCapitalize, autoCorrect, disabled, list, maxLength, minLength, name, pattern, readOnly, required, value, form, id: idProp, inputMode, defaultValue, autoFocus, tabIndex, spellCheck, onChange: onChangeProp, onFocus: onFocusProp, onBlur: onBlurProp, slotProps, ...restProps })=>{
